...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Care Home Connect | Find Licensed Residential Care Homes</title>
        <meta name="description" content="Connect with verified residential care homes featuring transparent pricing, amenities, and real reviews." />
        <link rel="canonical" href="https://carehomeconnect.com" />
      </Helmet>
        ...
        <section className="bg-care-50 py-16 px-4">
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <p className="text-lg mb-8 max-w-3xl mx-auto">
              Join thousands of families who have found the licensed care home for their loved ones through Care Home Connect.
            </p>
