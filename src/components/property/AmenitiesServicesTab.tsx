...
const allAmenities = [
  ...
  { id: "ensuite_rooms", label: "Ensuite Bathrooms" },
  { id: "garden", label: "Beautiful Garden" },
  { id: "communal_dining", label: "Communal Dining" },
  { id: "entertainment_area", label: "Entertainment Area" },
...
const allCareServices = [
  { id: "twenty_four_hour_staff", label: "24/7 Staff" },
...
const AmenitiesServicesTab = ({ 
  ...
  const saveAmenities = async () => {
    ...
    try {
      ...
      // Update UI
      if (onUpdate) {
        onUpdate({ amenities: selectedAmenities });
      }
  ...
  const saveServices = async () => {
    ...
    try {
      ...
      // Update UI
      if (onUpdate) {
        onUpdate({ careServices: selectedServices });
      }
